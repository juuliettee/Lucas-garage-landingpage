...
def verify_booking_token(token, max_age_seconds=86400):
    """
    Decodes and validates token. Rejects expired (>24h) or forged tokens.
    ...
    try:
        ...
        return False, "This booking confirmation link has expired. Please choose your slot again."
    except BadSignature:
